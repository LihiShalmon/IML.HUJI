...
if __name__ == '__main__':
    ...
    # code used to see what polynomial degree might be suitable for the data
    ...
    fig3 = px.scatter(grouped_data, x='Month', y='mean_temp', color='Country',
                      ...
                      title='Temperature mean and std as a function of month and country')
    ...
    for k in range(1,11,1):
        ...
        print("the error for k="+ str(k) + " is " + str(round_loss))
